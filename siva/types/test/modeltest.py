...
from siva.qt_bindings import Qt, QtCore
    ...
    def checkChildren(self, parent, currentDepth=0):
        ...
        for r in range(rows):
            ...
            for c in range(columns) :
                ...
                print("Modeltest.parent():  R,C = {},{}  Child:{}, Parent:{}".format(r, c, index.internalPointer(), parent.internalPointer()))
                ...
                try:
                    ...
                    print("Fail:  parent(child) != parent -- {}, {}", index.internalPointer(), parent.internalPointer())
                    raise
